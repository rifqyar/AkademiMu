...
export const SplashScreenAnimation = () => {
    ...
    const changeFlexHeader = useRef(new Animated.Value(0)).current;
        ...
        Animated.parallel([
            ...
            Animated.timing(
                moveTitle,{
                    toValue: {
                        x: 0,
                        y: -SIZES.height / 11//-(SIZES.height / 1.84) + SIZES.padding
                    }, useNativeDriver: false,
                    delay: 500
                }
            ),
    ...
    return {color, moveTitle, scaleText, opacityLogo, TextColorChange, contentTransition, changeFlexHeader}
}